module.exports = {
  ...
  transform: {
    ...
    '\\.*Worker.ts$':
      './node_modules/@marin/jest/jestBabelTransform',
  ...
  setupFilesAfterEnv: ['./node_modules/@marin/jest/setupTests.ts'],
  setupFiles: ['./node_modules/@marin/jest/jest.env.js'],
  ...
  moduleNameMapper: {
    ...
    '^@marin/([^/]+)/(.*)$':
      '<rootDir>/node_modules/@marin/$1/src/$2',
  },
};
